            ...
            <form action="" method="post" onSubmit={handleSubmit} style={{ width: '500px' }}>
                ...
                <div className="relative">
                    ...
                    <input
                        ...
                        className="block w-full p-4 pl-10 text-sm text-black border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:border-gray-600 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500"
